...
def get_loaders(
    ...
    for (path_img, path_mask) in zip(os.listdir(my_path + "\\data\\train_images\\"), os.listdir(my_path + "\\data\\train_masks\\")):
        ...
        augmentations = train_transform(image=image, mask=mask)
    ...
    # count = 0
    # for path_img in os.listdir(my_path + "\\data\\train_masks\\"):
    #     full_path_img = os.path.join(my_path + "\\data\\train_masks\\", path)
    ...
    #     augmentations = train_transform(mask=mask)
    ...
    # test_x = []
    # count = 0
    # for img_path in os.listdir(my_path + "\\data\\test_images\\"):
    ...
    for (path_img, path_mask) in zip(os.listdir(my_path + "\\data\\test_images\\"), os.listdir(my_path + "\\data\\test_masks\\")):
        ...
        augmentations = test_transform(image=image, mask=mask)
        # print(np.shape(augmentations["image"]))
